    ...
    <section className="lg:py-16">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
        <motion.div
          ...
          className="col-span-12 md:col-span-7 place-self-center text-center md:text-left justify-self-start"
        >
          ...
          >
            ...
            I am eager to gain hands-on experience and continuously learn new technologies to stay ahead in the ever-evolving tech landscape. My primary objective is to leverage my academic knowledge and personal abilities to contribute meaningfully to my organization’s success.
            With a strong sense of adaptability, creativity, and resourcefulness, I aim to drive positive growth for my team and company while developing into a well-rounded professional.
          </p>
          <div>
            <Link
              href="/#contact"
            ...
            <Link
              href="/cv.pdf" // Update this line to point to your CV file
